...
export const MockChainInfoDTO: ChainInfoDTO = ChainInfoDTOFromJSON({
  scoreHigh: "2",
...
export const MockNetworkConfigurationDTO: NetworkConfigurationDTO = NetworkConfigurationDTOFromJSON(
  {
    network: {
      identifier: "public",
    ...
    plugins: {
      ...
      namespace: {
        ...
        reservedRootNamespaceNames:
          "xem, nem, user, account, org, com, biz, net, edu, mil, gov, info, symbl, symbol, xym, dhealth, dhp",
